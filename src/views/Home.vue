<template>
  ...
  <div id="app">
    ...
    <div class="hidden lg:block">
      ...
      >
        <img src="../assets/grafik-home-1.png" alt="" class="w-1/2" />
      </div>
      <div class="flex flex-row justify-end absolute top-36 -right-56 w-3/4">
        <img src="../assets/grafik-home-2.png" alt="" class="w-1/2" />
      </div>
    </div>
